...
public class bl_OrbitButton : MonoBehaviour,IPointerDownHandler,IPointerEnterHandler,IPointerExitHandler,IPointerUpHandler
{
    ...
    [SerializeField]private bl_CameraOrbit CameraOrbit;
    [SerializeField]private Axys m_Axi = Axys.Horizontal;
    [SerializeField,Range(-15,15)]private float RotationAmount = 5;
    [SerializeField]private bool Maintain = false;
